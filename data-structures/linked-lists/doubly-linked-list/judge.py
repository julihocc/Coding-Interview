...
def run_case_logic(SolutionClass, case):
    """Test a single case for doubly linked list operations.
    ...
    if instance.traverse_forward() != case.expected_forward:
        return False

    # Check backward traversal
    expected_backward = (
        case.expected_backward
        if case.expected_backward
        else list(reversed(case.expected_forward))
    )
    if instance.traverse_backward() != expected_backward:
        return False
