...
def run_case_logic(sol_func, case):
    result = sol_func(list(case.nums), case.k)
...
def main():
    ...
    reference_solutions = load_solutions(solutions_dir, 'quickselect', 'reference')
    run_tests(reference_solutions, TEST_CASES, run_case_logic, 'REFERENCE SOLUTIONS')
    
    # Load and test contributed solutions
    contributed_solutions = load_solutions(solutions_dir, 'quickselect', 'contributed')
