...
def run_case_logic(SolutionClass, case):
    ...
    result = instance.quicksort(list(case.nums))
...
def main():
    ...
    reference_solutions = load_classes_with_method(solutions_dir, 'quicksort', 'reference')
    run_tests(reference_solutions, TEST_CASES, run_case_logic, 'REFERENCE SOLUTIONS')
    
    # Load and test contributed solutions
    contributed_solutions = load_classes_with_method(solutions_dir, 'quicksort', 'contributed')
