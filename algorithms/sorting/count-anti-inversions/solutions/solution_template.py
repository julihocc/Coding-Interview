...
class Solution:
    ...
    def count_anti_inversions(self) -> int:
        ...
        raise NotImplementedError("Counting strategy not implemented yet")
    ...
    def _merge_sort_and_count(self, arr: List[int], left: int, right: int) -> tuple[List[int], int]:
        ...
        raise NotImplementedError("Merge sort logic not implemented")
    ...
    def _merge_and_count(self, left: List[int], right: List[int]) -> tuple[List[int], int]:
        ...
        raise NotImplementedError("Merge and count logic not implemented")
