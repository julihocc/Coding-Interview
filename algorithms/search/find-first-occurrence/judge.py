...
def main():
    ...
    reference_solutions = load_solutions(solutions_dir, 'find_first_occurrence', 'reference')
    run_tests(reference_solutions, TEST_CASES, run_case_logic, 'REFERENCE SOLUTIONS')
    
    # Load and test contributed solutions
    contributed_solutions = load_solutions(solutions_dir, 'find_first_occurrence', 'contributed')
